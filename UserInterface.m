...
function app
    ...
    % Création d'un l'objet type 'textbox'
    ...
    %Ajout de donnée dans un ensemble pour récupération future
...
%Mise à jour du label, et des variables associées au fichier sélectionné
